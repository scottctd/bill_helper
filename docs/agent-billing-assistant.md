...
| `backend/services/agent/proposals/`, `backend/services/agent/tool_handlers_propose.py` | Proposal-family handlers plus group/pending-proposal coordination |
