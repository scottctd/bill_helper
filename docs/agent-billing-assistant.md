...
| API router      | `backend/routers/agent.py`, `backend/routers/agent_threads.py`, `backend/routers/agent_runs.py`, `backend/routers/agent_reviews.py`, `backend/routers/agent_attachments.py`, `backend/routers/agent_support.py`                                                                                                                                                                          | Thin transport aggregator plus focused HTTP modules for threads, runs, review actions, attachment downloads, and shared SSE/upload helpers                                                                                                                                                                                                                                                                                                                                   |
...
| `backend/routers/agent_support.py`                | Shared agent router helpers                                          |
