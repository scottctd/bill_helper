...
| Thread context               | `backend/services/agent/thread_context.py`, `backend/services/agent/message_history_content.py`, `backend/services/agent/attachment_content.py`                                                | Owned per-turn transcript assembly, prior canonical context, attachment extraction, PDF/image handling, and review prefixing                         |
