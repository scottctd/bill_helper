...
- Workspace dependency changes must keep `docker/agent-workspace-requirements.txt` aligned with the import closure of the installed `bh` CLI and document the fresh-image smoke test.
