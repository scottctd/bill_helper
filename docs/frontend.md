...
- thread rail running indicators use local optimistic state immediately when send starts, then reconcile with `GET /agent/threads` summary field `has_running_run`
