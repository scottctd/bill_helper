...
1. Treat scroll and overflow as architecture.
...
1. Preserve valuable bespoke interactions.
...
1. Agent/chat surfaces need stricter geometry than CRUD screens.
...
1. Read the current behavior first.
...
1. Audit the likely failure modes.
...
1. Verify both code and behavior.
...
1. Feed validated lessons back into the skill.
