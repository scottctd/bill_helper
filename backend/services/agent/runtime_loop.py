# CALLING SPEC:
# - Purpose: implement focused service logic for `runtime_loop`.
# - Inputs: callers that import `backend/services/agent/runtime_loop.py` and pass module-defined arguments or framework events.
# - Outputs: service functions, contracts, or helpers exported by `runtime_loop`.
