# CALLING SPEC:
# - Purpose: normalize account markdown and build current-user account context for system prompts.
# - Inputs: SQLAlchemy session, owner user id/name.
# - Outputs: truncated account markdown and multi-line current-user context block.
# - Side effects: reads owned accounts from the database.
