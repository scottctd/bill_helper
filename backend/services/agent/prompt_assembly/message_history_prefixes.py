# CALLING SPEC:
# - Purpose: assemble review-result prefix text prepended to the current-turn user message.
# - Inputs: SQLAlchemy session and thread id for the review window since the last user message.
# - Outputs: compact review outcome lines or None when no pending review actions exist.
# - Side effects: reads review actions and change items from the database.
