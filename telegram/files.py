# CALLING SPEC:
# - Purpose: provide Telegram integration behavior for `files`.
# - Inputs: callers that import `telegram/files.py` and pass module-defined arguments or framework events.
# - Outputs: Telegram handlers, models, or helpers exported by `files`.
