# CALLING SPEC:
# - Purpose: provide Telegram integration behavior for `charts`.
# - Inputs: callers that import `telegram/charts.py` and pass module-defined arguments or framework events.
# - Outputs: Telegram handlers, models, or helpers exported by `charts`.
