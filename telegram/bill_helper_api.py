# CALLING SPEC:
# - Purpose: provide Telegram integration behavior for `bill_helper_api`.
# - Inputs: callers that import `telegram/bill_helper_api.py` and pass module-defined arguments or framework events.
# - Outputs: Telegram handlers, models, or helpers exported by `bill_helper_api`.
