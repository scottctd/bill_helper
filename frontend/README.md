...
This file is intentionally thin. Canonical frontend documentation lives in `../docs/frontend.md`.
...
- Update the relevant `../docs/frontend/*.md` files and keep `../docs/frontend.md` current when the topic map changes.
