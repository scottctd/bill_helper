/**
 * CALLING SPEC:
 * - Purpose: render the `TaxonomyTermsSection` React UI module.
 * - Inputs: callers that import `frontend/src/features/properties/sections/TaxonomyTermsSection.tsx` and pass module-defined arguments or framework events.
 * - Outputs: React components and UI helpers exported by `TaxonomyTermsSection`.
