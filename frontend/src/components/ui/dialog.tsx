...
>(({ className, ...props }, ref) => <DialogPrimitive.Title ref={ref} className={cn("text-heading-20", className)} {...props} />);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn("text-copy-14 text-muted-foreground", className)} {...props} />
));
